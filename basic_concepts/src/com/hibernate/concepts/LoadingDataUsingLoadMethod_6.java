...
public class LoadingDataUsingLoadMethod_6 {
	...
	*/
	...
	public static void main(String[] args) {
		...
		// by default session.load() does lazy loading
		// at this line query won't run on database query will be generated when we call below methods
		Product productObject = session.load(Product.class, 1);
		System.out.println(productObject.getClass() + "\n" + productObject.getClass().getSuperclass()); // it is proxy class generated by hibernate
		
		// query will run on database for below methods but only one time
		System.out.println(productObject.toString());
		
		// non identifier method -- get value from real entity object
		System.out.println(productObject.getPname());
